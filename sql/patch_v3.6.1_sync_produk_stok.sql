-- v3.6.1 — Perbaiki proses_transaksi_atomic: setelah stok_movement, update kolom produk.stok
-- (sebelumnya hanya log movement; stok botol di UI tidak turun walau bibit turun.)
-- Jalankan 1x di Supabase SQL Editor. Tidak perlu ulang generate_nota / tabel lain.
